      ...
      <div className="bg-white px-4 md:px-16 lg:px-36 md:mt-24 mt-24">
        ...
        <div className="container mx-auto gap-6 flex flex-col md:flex-row">
          <div className="w-full md:w-9/12 mt-6 md:mt-0 relative ml-2">
            ...
            <p className="mt-8 text-gray-600 text-xl  space-y-2 md:mx-12">5.
            ...
            <p className="mt-8 text-gray-600 text-xl  space-y-2 md:mx-12">6.
            ...
            <p className="mt-8 text-gray-600 text-xl  space-y-2 md:mx-12">7.
            ...
            <p className="mt-8 text-gray-600 text-xl  space-y-2 md:mx-12">8.
